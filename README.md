...
- **여행 기록 목록**
  ...
  - 길게 누를 때(Long Click) 컨텍스트 메뉴(수정, 삭제) 플로팅
  - 삭제 시 `AlertDialog` 검증 단계를 경유하여 DB 행(Row) 및 내부 저장소 물리 파일 동시 제거
